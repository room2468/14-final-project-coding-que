...
class _MovieListState extends State<TopRating> {
  ...
  Future initialize() async {
    movies = [];
    _search = [];
    movies = await service.getTopRating();
    setState(() {
                    ...
                    return InkWell(
                      onTap: () {
                        MaterialPageRoute route =
                            MaterialPageRoute(builder: (_) => DetailPage(f));
                    ...
                    return InkWell(
                      onTap: () {
                        MaterialPageRoute route = MaterialPageRoute(
                            builder: (_) => DetailPage(movies[position]));
                        Navigator.push(context, route);
                      },
                      child: Card(
                        elevation: 2.0,
